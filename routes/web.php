...
Route::get('/companylist/{id}', [WelcomeController::class, 'companylist'])->name('welcome.companylist');
Route::get('/reviws/{id}', [WelcomeController::class, 'reviws'])->name('welcome.reviws');
...
Route::middleware(['auth', 'admin-access'])->group(function () {
    ...
    Route::get('/admin/all_category', [AdminController::class, 'allCategory'])->name('admin.all_category');
